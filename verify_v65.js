...
(async () => {
  ...
  try {
    ...
    await shot('v65_mouth.png', [b.cx - b.sx / 2 - L, b.cy + 8, b.cz], [b.cx - b.sx / 2 + 6, c[1], c[2]], ['plow'], 0.6);
    await shot('v65_exit.png', [b.cx + b.sx / 2 + L, b.cy + 8, b.cz], [b.cx + b.sx / 2 - 4, c[1], c[2]], ['plow'], 0.6);
    await shot('v65_top.png', [b.cx, b.cy + 72, b.cz + 4], c, ['plow'], 0.6);
    await shot('v65_bottom.png', [b.cx, b.cy - 60, b.cz + 4], c, ['plow'], 0.6);
    await shot('v65_near.png', [b.cx, b.cy + 10, b.cz + 62], c, ['plow'], 0.6);
    await shot('v65_far.png', [b.cx, b.cy + 10, b.cz - 62], c, ['plow'], 0.6);
    await shot('v65_iso.png', [b.cx - 40, b.cy + 55, b.cz + 70], c, ['plow'], 0.6);
    await shot('v65_machine.png', [185, 175, 235], [20, 35, 25], null, null);
    await page.evaluate(() => { window._showAllParts(); window._overrideAngle = null; window._setPanelCollapsed(false); });
    await page.waitForTimeout(600);
    await page.screenshot({ path: path.join(SHOT_DIR, 'v65_anim_t0.png') });
    console.log('Shot: v65_anim_t0.png (animating)');
    await page.waitForTimeout(2500);
    await page.screenshot({ path: path.join(SHOT_DIR, 'v65_anim_t1.png') });
    console.log('Shot: v65_anim_t1.png (animating, +2.5s)');
    ...
    console.log('ASSET_V (expect 49):', assetV);
    check(assetV === '49', 'ASSET_V 49 (v65 bare sheet, plow GLB rebuilt)');
    await page.close();
