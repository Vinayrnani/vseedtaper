...
// v13 verify: closed hopper + 2 side joints, half-pipe 16mm/8mm cover 11->6,
...
(async () => {
  ...
  await page.screenshot({ path: '/tmp/v13_side.png' });
  console.log('Screenshot /tmp/v13_side.png (side elevation)');
  await setView(20, 64, 110, 20, 58, 25);
  await page.screenshot({ path: '/tmp/v13_mouth.png' });
  console.log('Screenshot /tmp/v13_mouth.png (mouth closeup)');
  await showOnly(['hopper', 'cartridge', 'tape']);
  await setView(0, 38, 110, 0, 30, 25);
  await page.screenshot({ path: '/tmp/v13_drop.png' });
  console.log('Screenshot /tmp/v13_drop.png (drop closeup)');
  ...
  await page.screenshot({ path: '/tmp/v13_full.png' });
  console.log('Screenshot /tmp/v13_full.png (full assembly)');
  ...
  await page.waitForTimeout(400);
  await page.screenshot({ path: '/tmp/v13_anim.png' });
  console.log('Screenshot /tmp/v13_anim.png (animation frame)');
  ...
  await browser.close();
  console.log('\nBrowser closed. Shots: /tmp/v13_side.png /tmp/v13_mouth.png /tmp/v13_drop.png /tmp/v13_full.png /tmp/v13_anim.png');
