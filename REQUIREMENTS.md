...
8. **Corrections (review round 3)**: (1) tw_lift 14→20.5: rotor sweep radius = orbit 10 + bobbin r 10.35 = 20.35 (disc r14 is smaller); lift 20.5 keeps export min_z=0 with assert tw_lift >= tw_orbit + bob_d/2. Viewer twister pos [0,-20.5,0]. (2) assert delete range corrected: DELETE params L473-484 + L489-537; KEEP L485-488 (crank/drum gear-plane checks, unrelated to drive removal). (3) slot cutout goes in the chassis DIFFERENCE block at the ex-drop-pocket site (not the union); epsilon spelling. (4) drop-pocket param line is L434 (was miscited L435). (5) stale stations L362 comment ("overhead-drive parity") deleted in the twister rewrite. (6) hub/pin/eyelet X-layout (collision fixes): hub r10 x167..172 (bearing, 2mm from pedestal); disc r14 x167..170 (t3); pins R10 x170..179.5 (bases fused in disc/hub overlap, free east of x172); bobbins x169.5..180.6; eyelets R6 x170..176 r1.5 (bases fused, free posts east of x172); snap x182..184; new asserts hub-vs-pedestal ≥2, pin-tip-vs-snap ≥2, bobbin-vs-snap ≥1. Eyelet-vs-tube overlap is fused-base-by-design (documented, no assert). (7) bevel blank stays labelled NON-MESHING visual placeholder (never inherited as gear math).
9. **Corrections (review round 4 — bigger bay)**: (1) fundamental catch: Class-15 bobbin (r10.35) around Ø15 tube needs orbit R≥18.15 → R19 (bobbin inner clears tube by 1.15); small-orbit plans WITHDRAWN (R10/R11 would embed bobbins AND pins in the tube). (2) chassis_width 60→68, lane_y=34 (new param) replaces hardcoded y=30 for all centered geometry; back wall stays 0..3, front wall moves to 65..68; back-plane gear y=12 unchanged. (3) twister final: tube OD15/bore10; R19; disc r23 x167..170 t3; pins R19 Ø6 x170..179.5; bobbins x169.5..180.6; eyelets R12 x170..176 r1.5 (90°/270°); snap x182..184; X stack-up otherwise unchanged (mouth 160 … pull face 186.35). (4) sweep outer 29.35 → tw_lift=29.5 (min_z +0.15), viewer twister pos [0,-29.5,0]; slot x166..183 y7..61 through base; feet 12×12 to z=-15 (dip -12.35, clearance 2.65); chassis export +15 lift; bevel blank annulus r16..22 visual-only. (5) viewer: CAD-y-derived positions shift +4 (viewer_y = CAD_y - 13); ASSET_V 45→46. (6) absolute-Y audit (grep every hardcoded 30/60/58/57) is part of implementation; gear-train-later plan unchanged.
10. **Corrections (review round 5)**: (1) dead-axle shafts drum/takeup/spool `*_y1` 59→67 + asserts 58..60→66..68 (front wall moves to 65..68); overhead countershaft y1 dies with the drive deletion — no shift. (2) overhead 45.5 items need NO shift — entire overhead section (params/asserts/geometry incl. friction tangency + hanger posts) is deleted; deletion list covers them. (3) front gear mesh preserved: `gear_local_y` -20→-24 (crank gear 56→52 vs drum 51.95) + assert windows 44..52 re-centered accordingly; crank/drum gears STAY (core drive, not old chassis gears). (4) plow mount holes py [6,54]→[6,62]. (5) disc-top assert gets margin: <= 41 (was exact 40). (6) chassis viewer re-seat: PART_DEF pos [0,0,0]→[0,-15,0] (follows -lift pattern: export +15 lift, viewer compensates; hopper precedent). (7) `twister_lift` DELETED, `tw_lift`=29.5 NEW (rename, not alias); withdrawal reworded: R10/R11 withdrawn on bobbin-vs-tube (pins at R11 do clear). (8) audit grep widened: 59, 54, `gear_local_y`, `shaft_y1`, plow-hole literals (plus confirm-zero for deleted overhead/rod/ring symbols).
